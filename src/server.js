...
const limiter = rateLimit({
  ...
  max: 30, // 30 requests per minute for auth endpoints (increased for development)
...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      scriptSrc: ["'self'", "'unsafe-inline'", "'unsafe-eval'", "https://cdn.jsdelivr.net", "https://cdnjs.cloudflare.com", "https://auth.magic.link", "https://unpkg.com", "https://cdn.skypack.dev", "https://static.cloudflareinsights.com", "https://*.magic.link", "https://code.jquery.com"],
      imgSrc: ["'self'", "data:", "https:"],
      connectSrc: ["'self'", "https://genobank.app", "https://auth.magic.link", "https://*.magic.link", "wss:", "https:"],
...
// Proxy routes for GenoBank API calls
app.use('/proxy', apiLimiter, proxyRoutes);
